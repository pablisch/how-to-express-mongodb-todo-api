...
NEXT:
[GET /todos route in app.js (simple version)](4.AddTheGetTodosEndpoint.md)
[GET /todos route as controller function and route](6.AddGetTodosEndpointAsControllerAndRoute.md)
